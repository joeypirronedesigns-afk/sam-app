...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const url = `${SUPABASE_URL}/rest/v1/sam_users?email=eq.${enc}&select=uid,email,name,tier,voice_profile,voice_version,sam_context,created_at&order=last_seen.desc.nullslast&limit=1`;
